...
const TOGGLEABLE_ADDONS: AddonRow[] = [
  {
    ...
    name: "Smart AI RO Intake",
    priceLabel: SMART_RO_ADDON_LABEL,
    description:
      "Free-form text → Gemini parse → staging review → estimate with labor jobs (AI Plus).",
  },
];
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">
            Billable extras — override plan defaults per shop. Also enable AI suite under Release
            flags when turning on Smart Intake.
          </p>
        </div>
      </div>
