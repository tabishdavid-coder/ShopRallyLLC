...
export async function askSupportAi(
  ...
  const { text } = await createAiMessage({
    ...
    system:
      ...
      "info@getshoprally.com. Do not invent features. Format with short paragraphs or bullets.",
    userContent: `FAQ knowledge base:\n\n${faqContext}\n\n---\n\nUser question: ${question.trim()}`,
  });

  return {
    answer: text || "I couldn't find an answer. Please contact info@getshoprally.com.",
    source: "ai",
    relatedSlugs: [],
  };
}
