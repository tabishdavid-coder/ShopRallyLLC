...
| A1-014 | P3 | Dead `home-hero.tsx` | `home-hero.tsx` | Unused alternate hero still has migration overclaim; home uses `Hero.tsx`. | Open |
...
| A2-001 | P1 | Home hero / switch strip | `Hero.tsx`; `home-hero.tsx` | Overclaims free migration / full history. Cross-ref **A1-004** / **A5-002**. | Fixed |
| A2-002 | P1 | Legal metadata | `src/app/legal/*` | Double `— ShopRally` titles. | Open |
| A2-003 | P1 | Competitor price helper | `plans.ts` `COMPETITOR_BENCHMARK` | Shopmonkey/Tekmetric CRM benchmarks stale. | Open |
...
| A2-005 | P2 | Docs vs UI scarcity | `GROWTH-POSITIONING.md` | Docs claim “50 founding seats”; UI retired seat-count urgency. | Open |
| A2-006 | P3 | Testimonials | Marketing site | Anonymous testimonials not present — no action. | Won't fix |
| A2-007 | P3 | Lighthouse SEO | — | Skipped this pass. | Won't fix |
